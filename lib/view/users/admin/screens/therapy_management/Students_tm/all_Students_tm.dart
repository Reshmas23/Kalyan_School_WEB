...
import 'package:vidyaveechi_website/view/users/admin/screens/therapy_management/Students_tm/all_std_datalist.dart';
import 'package:vidyaveechi_website/view/users/admin/screens/therapy_management/Students_tm/tm_std_details.dart';
...
class AllStudentInTherapy extends StatelessWidget {
  final TherapyController therapyController = Get.put(TherapyController());
  AllStudentInTherapy({super.key});
  ...
  //   therapyController.fetchAllStudents();
